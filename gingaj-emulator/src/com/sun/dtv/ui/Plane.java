...
public abstract class Plane extends ScarceResourceImpl
{
	...
	{
		setupListeners.add(new PlaneSetupListenerAndPattern(listener));
	}
	...
	{
		setupListeners.add(new PlaneSetupListenerAndPattern(listener, pattern));
	}
