...
public class AppDataPanel extends JPanel implements ActionListener, KeyListener {
    ...
    public AppDataPanel(AppTreeWindow appWin) {
        ...
        fieldLabels[NAME] = new JLabel("Name: ", SwingConstants.RIGHT);
        ...
        fieldLabels[CLASSPATH] = new JLabel("Path: ", SwingConstants.RIGHT);
        ...
        fieldLabels[XLETNAME] = new JLabel("Xlet: ", SwingConstants.RIGHT);
