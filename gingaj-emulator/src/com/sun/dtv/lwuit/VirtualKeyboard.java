				...
				public void actionPerformed(ActionEvent event) {
					...
					if (name.equalsIgnoreCase("mode")) {
						if (currentMode.equalsIgnoreCase("ABC")) {
							...
							keyboard.buildKeyboard(VirtualKeyboard.QWERTY_MODE);
						} else if (currentMode.equalsIgnoreCase("123")) {
							currentMode = "ABC";

							keyboard.buildKeyboard(VirtualKeyboard.NUMERIC_SYMBOL_MODE);
						} else if (currentMode.equalsIgnoreCase("SYM")) {
							currentMode = "ABC";

							keyboard.buildKeyboard(VirtualKeyboard.SYMBOL_MODE);
						}
