...
public class GingaJProxy implements ApplicationProxy {
    ...
    public void load() throws Exception {
        ...
        String mainclass = impl.getDocument();
        String paths = impl.getClasspath();
        String basedirectory = impl.getBaseDirectory();
        String extraclasspath = br.org.sbtvd.config.Settings.getInstance().getProperty("extra.class.path");
...
//            URLClassLoader mainClassLoader = (URLClassLoader)getClass().getClassLoader();
            MainClassLoader mainClassLoader = new MainClassLoader(new URL[0]);
            /*
