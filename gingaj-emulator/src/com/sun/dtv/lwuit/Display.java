...
//					||
//				((RemoteControlEvent)events[i]).getKeyCode() == RemoteControlEvent.VK_ALPHANUMERIC
//					||
...
//					||
//				((RemoteControlEvent)events[i]).getKeyCode() == KeyEvent.VK_BACK_SPACE
//					||
//				((RemoteControlEvent)events[i]).getKeyCode() == KeyEvent.VK_ESCAPE)
//				{
