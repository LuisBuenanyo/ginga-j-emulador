...
//    //public static final String PATH_CONFIG_FILE   = "config/settings.xml";    
    public static String PATH_SETTINGS   = "/config/settings.txt";
...
//    public static final String TVGUI_CLOSE    = "img/window_close.png";
	...
	public static final String BCTPATH = "./supporting_files/broadcastevent.bct";
...
//    	PATH_SETTINGS   = this.getClass().getResource("/config/settings.txt").toString();
