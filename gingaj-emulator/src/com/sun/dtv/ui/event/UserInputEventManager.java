	...
	public boolean dispatchUserInputEvent(UserInputEvent event) {
		...
		while (it.hasNext()) {
			...
			if (index != -1) {
				...
				listUIEventListener.add(entry.getKey());
			...
			if (targetEvent instanceof com.sun.dtv.ui.event.KeyEvent && event instanceof com.sun.dtv.ui.event.KeyEvent) {
				...
				if (targetEvent instanceof com.sun.dtv.ui.event.RemoteControlEvent) {
					...
					if ((re.getKeyCode() == com.sun.dtv.ui.event.RemoteControlEvent.VK_COLORED_KEY_0 && e2.getKeyCode() == java.awt.event.KeyEvent.VK_F1)
						...
						if (e2.getKeyCode() == 40) {
							e2.setKeyCode(java.awt.event.KeyEvent.VK_DOWN);

							flag = true;
						}
					} else if (re.getKeyCode() == java.awt.event.KeyEvent.VK_UP) {
						if (e2.getKeyCode() == 38) {
							e2.setKeyCode(java.awt.event.KeyEvent.VK_UP);

							flag = true;
						}
					} else if (re.getKeyCode() == java.awt.event.KeyEvent.VK_LEFT) {
						if (e2.getKeyCode() == 37) {
							e2.setKeyCode(java.awt.event.KeyEvent.VK_LEFT);

							flag = true;
						}
					} else if (re.getKeyCode() == java.awt.event.KeyEvent.VK_RIGHT) {
						if (e2.getKeyCode() == 39) {
							e2.setKeyCode(java.awt.event.KeyEvent.VK_RIGHT);
					...
					} else if (re.getKeyCode() == java.awt.event.KeyEvent.VK_ESCAPE) {
						if (e2.getKeyCode() == 61538) {
							e2.setKeyCode(java.awt.event.KeyEvent.VK_ESCAPE);

							flag = true;
						} else if (e2.getKeyCode() == java.awt.event.KeyEvent.VK_ESCAPE) {
							flag = true;
						}
					...
					} else if (re.getKeyCode() == java.awt.event.KeyEvent.VK_PAUSE) {
						if (e2.getKeyCode() == 61450) {
							e2.setKeyCode(java.awt.event.KeyEvent.VK_PAUSE);
